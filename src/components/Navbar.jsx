...
import { avatar, logo, menu, close } from "../assets";
    ...
    >
      <div className="w-full flex justify-between item-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold flex cursor-pointer'>Ricardo &nbsp;<span className='sm:block hidden'>| Fullstack Developer</span></p>
        </Link>
